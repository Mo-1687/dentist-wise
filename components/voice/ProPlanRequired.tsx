...
import WelcomeBadge from "../WelcomeBadge/WelcomeBadge";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
        ...
        <WelcomeBadge
          heading="Voice Assistant Access Required"
          description="Upgrade to AI Pro or AI Basic to unlock unlimited voice
                    consultations with our AI dental assistant."
          icon={<MicIcon className="w-16 h-16 text-primary" />}
          BadgeIcon={<LockIcon className="w-4 h-4 text-primary" />}
          text="Pro Feature"
        />
